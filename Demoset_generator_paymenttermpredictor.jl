...
if number_of_variables > 6
	@bind params_7 choose_parameters(distributions_types[7], variables[7])
else
	params_7 = nothing
end
...
if number_of_variables > 7
	@bind params_8 choose_parameters(distributions_types[8], variables[8])
else
	params_8 = nothing
end
...
begin
	...
	if number_of_variables > 6
		distribution_7 = compose_distribution(params[7], distributions_types[7]);
	else
		distribution_7 = nothing
	end

	if number_of_variables > 7
		distribution_8 = compose_distribution(params[8], distributions_types[8]);
	else
